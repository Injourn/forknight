...
namespace Forknight.Controllers
{
    public class ListingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Price,Name,dayListed,Image")] Listing listing)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Price,Name,dayListed,Image")] Listing listing)
        {
            if (id != listing.Id)
            {
                return NotFound();
